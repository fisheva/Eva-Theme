...
Due to some technical reasons, currently Eva Theme for VS needs to be used with my font and colors setting file(Latest update 2021-09-22). Please <a href="https://github.com/fisheva/Eva-Theme/blob/master/Visual%20Studio/fonts-and-colors.vssettings" target="_blank" download="fonts-and-colors.vssettings">download</a> and import it.
