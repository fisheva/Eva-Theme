...
<p style="display: flex;flex-flow: row wrap;">
    <a title="JetBrains" style="text-decoration:none;color:#ffffff00;" href="https://jb.gg/OpenSourceSupport" target="_blank">
        <img class="sponsor" width="50px" height="50px" aligh="left" style="background:#EDF0F7;border-radius:25px;margin-right:2px;" src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" referrerpolicy="no-referrer">
    </a>
    <a title="Andreas Kanz" style="text-decoration:none;color:#ffffff00;" href="https://github.com/akanz1" target="_blank">
        <img class="sponsor" width="50px" height="50px" aligh="left" style="background:#EDF0F7;border-radius:25px;margin-right:2px;" src="https://avatars.githubusercontent.com/u/51492342?v=4" referrerpolicy="no-referrer">
    </a>
</p>